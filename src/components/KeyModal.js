			...
			<div className="bg-surface rounded-xl sm:rounded-2xl shadow-xl max-w-md w-full p-4 sm:p-6 max-h-[90vh] overflow-y-auto">
				...
				<div className="mb-4 sm:mb-6">
					...
					<div className="mb-3 sm:mb-4">
						<div className={`relative p-3 sm:p-4 rounded-lg sm:rounded-xl border-2 ${checkKeyExpiry()
							...
							<input
								...
								readOnly
								className={`w-full text-sm sm:text-lg font-mono text-center tracking-[0.2em] sm:tracking-[0.3em] bg-transparent border-none outline-none ${checkKeyExpiry()
										? 'text-red-500'
										: 'text-primary'
									}`}
							/>
